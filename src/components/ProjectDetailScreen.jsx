...
const ProjectDetailScreen = () => {
  ...
  const projectTasks = tasks.filter(task => {
    const taskProjectId = typeof task.projectId === 'string' ? parseInt(task.projectId) : task.projectId
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="bg-white rounded-3xl shadow-xl p-6 lg:p-8">
        ...
        {/* Project Card */}
        <div className={`${project.color} rounded-2xl p-6 lg:p-8 text-white mb-6`}>
          ...
          <p className="text-sm lg:text-base opacity-90">{formatDate(project.date)}</p>
        </div>
