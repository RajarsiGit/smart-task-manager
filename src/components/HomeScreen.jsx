  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-8">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex gap-4">
              <button onClick={() => navigate('/project/new')} className="px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition font-medium">
                + New Project
              </button>
              <button onClick={() => navigate('/task/new')} className="px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition font-medium">
                + New Task
              </button>
              <button className="p-3 bg-gray-100 rounded-xl hover:bg-gray-200" onClick={() => navigate('/calendar')}>
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </button>
              <button className="p-3 bg-gray-100 rounded-xl hover:bg-gray-200" onClick={() => navigate('/profile')}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {projects.map((project) => (
                  ...
                  >
                    ...
                    <p className="text-sm opacity-80">{formatDate(project.date)}</p>
                  </div>
                ))}
              </div>
            )}
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg transition ${activeTab === 'all' ? 'bg-purple-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                >
                  All
                </button>
                <button
                  onClick={() => setActiveTab('progress')}
                  className={`px-4 py-2 rounded-lg transition ${activeTab === 'progress' ? 'bg-purple-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                >
                  In Progress
                </button>
                <button
                  onClick={() => setActiveTab('completed')}
                  className={`px-4 py-2 rounded-lg transition ${activeTab === 'completed' ? 'bg-purple-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                >
                  Completed
                </button>
              </div>
                ...
                {filteredTasks.map((task) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <span className="text-gray-700 font-medium block truncate">{task.title}</span>
      ...
      <div className="bg-white rounded-3xl shadow-xl p-6 mb-8">
        <div className="flex justify-between items-center mb-6">
          <button onClick={() => navigate('/project/new')} className="p-2 hover:bg-gray-100 rounded-full">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
          </button>
          <button className="p-2 bg-gray-100 rounded-full hover:bg-gray-200" onClick={() => navigate('/calendar')}>
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
          </button>
          <button className="p-2 bg-gray-100 rounded-full hover:bg-gray-200" onClick={() => navigate('/profile')}>
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
            </svg>
          </button>
        ...
        <div className="flex gap-4 border-b pb-4 mb-6">
          <button
            onClick={() => setActiveTab('all')}
            className={`pb-2 ${activeTab === 'all' ? 'border-b-2 border-purple-600 text-purple-600 font-semibold' : 'text-gray-400'}`}
          >
            My Tasks
          </button>
          <button
            onClick={() => setActiveTab('progress')}
            className={`pb-2 ${activeTab === 'progress' ? 'border-b-2 border-purple-600 text-purple-600 font-semibold' : 'text-gray-400'}`}
          >
            In progress
          </button>
          <button
            onClick={() => setActiveTab('completed')}
            className={`pb-2 ${activeTab === 'completed' ? 'border-b-2 border-purple-600 text-purple-600 font-semibold' : 'text-gray-400'}`}
          >
            Completed
          </button>
        </div>
      ...
      <div className="bg-white/90 backdrop-blur rounded-3xl shadow-xl p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold">
            {activeTab === 'all' ? 'All Tasks' : activeTab === 'progress' ? 'In Progress' : 'Completed'}
          </h2>
          <button
